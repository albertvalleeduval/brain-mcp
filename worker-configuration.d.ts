/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2bca7e5af2fc55cf975ceb336be2cafe)
// Runtime types generated with workerd@1.20260701.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").BrainMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BrainMCP";
	}
